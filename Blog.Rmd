...
Many of these topics do indeed appear to be quite negative. 

A sentiment analysis builds on a word frequency analysis; it helps us to determine which tools we could use to 

- You could use a sentiment analysis to quickly identify which comments or sentences in a given document are more positive or negative.
