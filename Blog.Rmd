...
Another approach to qualitative analysis is sentiment analysis. A sentiment analysis looks at the emotional meaning of words, by classifing each word into a sentiment category. For example, the word 'encourage' might be coded as 'positive' in sentiment, whilst the word 'scream' would probably be coded as 'negative'. There are a number of different sentiment dictionaries which approach this in different ways. 

For this example, I've scraped a small ammount of comment data from Reddit, from a popular subreddit /r/politics. This is a popular subreddit which discusses a number of political topics. 
